...
import { MetricasTransmisionComponent } from './metricas-transmision.component';
import { FiltrosSeries, MetricasTransmisionService } from '../../services/metricas-transmision.service';
import {
  SerieMetrica,
  SeriesTransmision,
...
describe('MetricasTransmisionComponent', () => {
  let component: MetricasTransmisionComponent;
  let fixture: ComponentFixture<MetricasTransmisionComponent>;
  ...
  async function montar(queryParams: Record<string, string> = {}): Promise<void> {
    ...
    await TestBed.configureTestingModule({
      imports: [MetricasTransmisionComponent],
      providers: [
        { provide: MetricasTransmisionService, useValue: analyticsServiceMock },
    ...
    fixture = TestBed.createComponent(MetricasTransmisionComponent);
